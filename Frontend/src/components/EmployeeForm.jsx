  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-6 animate-fade-in">
      <form
        ...
        className="relative bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 shadow-2xl rounded-2xl p-8 mb-6 overflow-hidden transform transition-all duration-500 hover:shadow-3xl"
        style={{
      ...
      >
        ...
        <div className="mb-8 text-center transform transition-all duration-500 hover:scale-105">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm">Fill in the details below to add a team member</p>
        </div>
              ...
              >
                <label
                  className={`absolute left-4 transition-all duration-300 pointer-events-none font-medium ${
                    employee[field.name] || focusedField === field.name
        ...
        <div className="flex justify-center">
          <button
            ...
            className={`
              relative px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-xl
